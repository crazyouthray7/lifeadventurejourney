...
export const SCENES = [
  {
    ...
    maxAge: 19,
    title: '清晨五點二十的客運',
    text: '媽媽在客運站幫你拉了兩次行李箱的拉鏈，說「到了打個電話」。車窗外的故鄉一點一點退成地平線，你第一次覺得，票根上「台北」兩個字重得像一塊石頭。',
    tag: '離家｜獨立',
    once: true,
  ...
  },
  {
    ...
    maxAge: 24,
    title: '打工換來的一疊紙鈔',
    text: '二十一歲前夕，你數著這學期打工攢下的三萬二。室友約你暑假去澎湖，說機票船票加民宿「一人八千」。窗外的蟬叫得很大聲，大學生活快結束了，而你不確定該把這疊錢花在哪裡。',
    tag: '大學｜金錢',
    once: true,
    cond: (S) => S.education === 'university' || S.education === 'graduate',
    opts: [
      {
        label: '去澎湖，有些風景只有這個夏天有',
        hint: '把錢換成記憶，也是一種投資',
  ...
  },
  {
    ...
    maxAge: 21,
    title: '實習生名牌的第一天',
    text: '你的名牌掛繩比正式員工短一截，工位被晾在角落。主管丟給你一份四十頁的簡報說「先看熟」，午休時沒人叫你一起去吃飯。窗外的101在正午的陽光裡反著光，你第一次聞到職場的味道——咖啡、影印機，還有一點緊張。',
    tag: '職場｜大學',
    once: true,
    cond: (S) => S.education === 'university' || S.education === 'graduate',
    opts: [
  ...
  },
  {
    ...
    maxAge: 24,
    title: '第一天就被記住的名字',
    text: '上班第一天，行政把你的帳號權限搞錯三次，你蹲在茶水間跟IT借VPN。下午五點，主管走過你位置丟下一句「明天開會要用，今晚給我」。你看了看時間，離末班捷運還有五個小時。',
    tag: '職場｜新人',
    once: true,
  ...
  },
  {
    ...
    maxAge: 24,
    title: '末班捷運的座位',
    text: '末班捷運的座位空了大半，你靠著車門把手滑手機，群組裡主管還在追明天的進度。列車鑽進隧道，窗玻璃映出一張陌生的、沒什麼血色的臉。你算了算，這是本週第三次搭末班車回家。',
    tag: '職場｜加班',
    once: true,
    cond: (S) => S.job !== null || (S.education !== 'university' && S.education !== 'graduate'),
  ...
  },
  {
    ...
    maxAge: 24,
    title: '月底的餘額',
    text: '房租一萬五、水電瓦斯、便當錢，你的薪資明細躺在手機裡，扣完一切，餘額顯示 NT$ 3,280。你在便利商店門口站了三十秒，最後走進去，買了一杯最便宜的咖啡。',
    tag: '職場｜生活',
    once: true,
    cond: (S) => S.job !== null || (S.education !== 'university' && S.education !== 'graduate'),
    opts: [
  ...
  },
  {
    ...
    maxAge: 24,
    title: '隔壁公司開出的條件',
    text: '獵頭把一張 offer 推到桌上：月薪多八千、週休二日、離你家兩站捷運。但現在的主管昨天才說，下個月要提拔你帶一個小專案。兩張紙擺在你面前，一張是錢，一張是剛建立起來的信任。',
    tag: '職場｜抉擇',
    once: true,
    cond: (S) => S.job !== null,
    opts: [
