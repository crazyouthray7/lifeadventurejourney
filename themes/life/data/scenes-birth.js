export const SCENES = [
  {
    ...
    maxAge: 0,
    title: '北方，醫院的雨聲',
    text: '產房的空調嗡嗡作響，窗外的雨打在不鏽鋼窗框上，城裡的夜濕得能擰出水。護理師托著你的後頸，一道刺目的光劈開水氣——你第一次睜眼，看見一張哭著笑的臉，和走廊盡頭一個壓低聲音、反覆確認數字的側影。你哭出第一聲，雨聲忽然都遠了。',
    tag: '家庭｜出生',
    weight: 1,
    once: true,
  ...
  },
  {
    ...
    maxAge: 0,
    title: '中部，入秋的第一道太陽',
    text: '中部大醫院的產房外是乾爽的早晨，太陽把榕樹的影子曬進長廊。阿姨們擠在會客室，比手畫腳爭著要幫你想名字，護理師說你出生時哭聲又亮又響，整層樓都聽見了。你打了個哈欠，第一次看清天花板那排日光燈——十六根，亮晃晃的，像一條沒人排好的路。',
    tag: '家庭｜出生',
    weight: 1,
    once: true,
  ...
  },
  {
    ...
    maxAge: 0,
    title: '南方，港邊的風灌進產房',
    text: '港邊的風捲進婦產科二樓，空氣裡混著鐵鏽與海味。南方的日頭毒辣，護理師拉上簾子的時候，你隱約聽見碼頭貨櫃起重機咿呀作響。媽媽的嘴唇乾裂，還是低頭親了親你的額頭。你握著拳，像是在跟這座炎熱的南方城市宣戰。',
    tag: '家庭｜出生',
    weight: 1,
    once: true,
...
export const BIRTH_MILESTONES = [
  {
    ...
    age: 0,
    title: '誕生',
    text: '你在一聲啼哭裡報到，這座城的第一口空氣灌進肺裡。還沒想好要怎麼活，就有人開始替你決定接下來的事了——出生在哪裡，家裡過什麼樣的日子，會決定你前幾年看見什麼、聽到什麼、害怕什麼。',
    kind: 'choice',
    opts: [
      {
        label: '北方・老公寓的三合板隔間',
        hint: '爸爸在工地，媽媽在早餐店；夜裡城市高架的轟隆聲從隔間縫鑽進來',
      ...
      {
        label: '南方・港邊的公寓五樓',
        hint: '爸爸在貨櫃場輪班，媽媽在港區工業園區；晚上海風把雨棚吹得啪啪響',
