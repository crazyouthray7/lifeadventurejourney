...
export const SCENES = [
  ...
  },
  {
    ...
    maxAge: 70,
    title: '火車沿著海岸線慢慢開',
    text: '你說要去看看年輕時沒看過的風景，於是買了兩張火車票。車窗的風灌進來，海在右手邊一路沒斷。老伴在對座剝橘子，說「這趟等你退休，等了好多年」。小販推著餐車經過，她問你要不要吃池上便當。',
    tag: '老後｜生活',
    weight: 1,
    once: true,
    cond: (S) => !!S.spouse,
  ...
  },
  {
    ...
    maxAge: 85,
    title: '白花前的鞠躬',
    text: '殯儀館的冷氣很強，白花一排排擺在靈堂前。你看著放大的照片裡，他還是那年公園下棋時精神奕奕的樣子。司儀喊著家屬答禮，你彎下腰，忽然想起約好秋天要一起去爬山，還有好多話，沒來得及說。',
    tag: '老後｜告別',
    weight: 1,
    once: true,
    opts: [
      {
        label: '在靈前深深鞠三個躬，替他說出沒說完的話',
  ...
  },
  {
    ...
    maxAge: 90,
    title: '老照片裡的人',
    text: '你翻出幾十年前的老照片，泛黃的邊角捲起來。照片裡的人有的還在，有的已經走了。你一張張看完，發現自己一點也不怕那條終點線，怕的是還沒來得及好好告別。窗外的晚霞燒成一片橘紅，你把照片按年份一張張排好。',
    tag: '老後｜生死',
    weight: 1,
    once: true,
    opts: [
  ...
  },
  {
    ...
    maxAge: 90,
    title: '把話說清楚的那一晚',
    text: '全家難得聚齊的晚餐後，你留大家在客廳。你拿出一個牛皮紙袋，裡面是地契、印章、你寫好的那幾頁字。你說：「有些事，趁我清醒的時候講清楚，你們以後才不用吵架。」客廳很安靜，只聽得見電扇嗡嗡地轉。',
    tag: '老後｜生死',
    weight: 1,
    once: true,
    opts: [
  ...
  },
  {
    ...
    maxAge: 85,
    title: '老伴的白髮',
    text: '早晨你醒得早，替老伴把枕邊的藥分好，水杯擺在她手邊。她笑你越來越囉嗦，說你以前可是連自己的健保卡都會弄丟的人。你們沒有再講年輕時的情話，只是靜靜坐在餐桌兩頭，吃著同樣的稀飯，偶爾抬頭笑一下。光從窗口照進來，把兩個影子靠得很近。',
    tag: '老後｜家庭',
    weight: 1.2,
    once: true,
    cond: (S) => !!S.spouse,
  ...
  },
  {
    ...
    maxAge: 90,
    title: '孫子問你：死掉會去哪裡',
    text: '孫子坐在你腿上，忽然仰頭問：「阿公，人死掉會去哪裡？」你被問得一愣，看見他眼裡的認真。窗台上那盆你種了很久的蘭花剛開了花，你低頭看他，發現有些問題繞了大半生，還是第一次有人這樣問你。',
    tag: '老後｜家庭',
    weight: 1,
    once: true,
    cond: (S) => S.children.length > 0,
