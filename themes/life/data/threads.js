...
export const THREAD_SCENES = [
  ...
  },
  {
    ...
    maxAge: 31,
    title: '搬進新家的第三個紙箱',
    text: '三十歲這年，你搬進自己的房子。整理到第三個紙箱，滾出一張寫著字、邊角捲起的便條紙——二十歲那年的你，在宿舍頂樓的風裡，記下三件想做的事：考到駕照、存下第一桶金、跟家人去一趟海邊小鎮。你一條一條讀完，才發現前兩件不知不覺都做到了，第三件卻一直停在紙上。',
    tag: '伏筆｜夢想｜回訪',
    once: true,
    opts: [
      {
        label: '當天撥電話回家：「這個月，去海邊小鎮吧」',
        hint: '三件想做的事，別再讓它等',
  ...
  },
  {
    ...
    maxAge: 28,
    title: '人才庫裡沉睡三年的名字',
    text: '週四下班前，人事轉來一封邀約，對方公司說是在人才庫看到你的資料，附了一句：「你三年前更新過履歷，怎麼一直沒再動過？」你想起那個末班地鐵的深夜，你在車廂裡一字一句重寫履歷，車窗玻璃映著自己蒼白的臉。那個替自己留後路的你，終於收到了回音。',
    tag: '伏筆｜職涯｜回訪',
    once: true,
    opts: [
      {
  ...
  },
  {
    ...
    maxAge: 58,
    title: '健檢報告上的三排紅字',
    text: '五十七歲，健檢報告攤在桌上，心臟、肝、血糖三排紅字。醫生推了推眼鏡，語氣平淡：「這個年紀，身體開始要你償還年輕時的帳了。」你想起二十多歲那些末班地鐵的夜晚、凌晨兩點的公司、會議室裡三份便當兩杯咖啡的日子。你一直以為身體是無限額度的信用卡，現在才發現，帳單早就寄到了。',
    tag: '伏筆｜健康｜清算',
    once: true,
    opts: [
      {
  ...
  {
    id: 'life_thread_immigrate_001',
    act: 'midlife',
    stage: 'midlife',
    minAge: 36,
    maxAge: 60,
    title: '異鄉的第一個冬天',
    text: '移居海外的第一個冬天，窗外下著不認識的雪。你站在超市貨架前，忽然找不到小時候那罐辣醬，愣了好一會兒。手機響起，是媽媽打來的視訊，問你那邊冷不冷、有沒有好好吃飯。',
    tag: '伏筆｜移居｜鄉愁',
    once: true,
    ...
    opts: [
      {
        label: '接起視訊，說「一切都好」',
        hint: '報喜不報憂，也是長大',
        effects: { family: 5, mood: 4, stress: -2 }
      },
      {
        label: '買一箱食材，做一桌家鄉菜',
        hint: '味道是最短的回鄉路',
        effects: { mood: 5, arts: 2, stress: -3, money: -3000 }
      },
      {
        label: '約同樣移居的同事一起過節',
        hint: '異鄉人互相取暖',
      ...
      },
      {
        label: '一個人去公園走走，慢慢習慣',
        hint: '把陌生住成熟悉',
        effects: { independence: 4, mood: 2, stress: -2 }
      }
    ]
  },
  {
    id: 'life_thread_immigrate_002',
    act: 'midlife',
    stage: 'midlife',
    minAge: 45,
    maxAge: 65,
    title: '回鄉的班機',
    text: '移居多年後，你終於訂了回鄉的機票。機場通關時，工作人員問你回國的目的，你脫口而出「回家」，才發現這兩個字說得有點重。靠窗的位置，雲海在腳下鋪成一片白。',
    tag: '伏筆｜移居｜回訪',
    once: true,
    cond: (S) => !!S.flags.abroad,
    opts: [
      {
        label: '一下飛機就去吃記憶裡的那碗麵',
        hint: '味道認得回家的路',
        effects: { mood: 6, family: 4, money: -2000 }
      },
      {
        label: '先回家，陪爸媽好好吃頓飯',
        hint: '有些陪伴不能等',
        chars: { mom: { rel: 5, met: true }, dad: { rel: 4, met: true } },
        effects: { family: 8, mood: 6, stress: -4 }
      },
      {
        label: '把故鄉的街道慢慢走一遍',
        hint: '看看它變成什麼樣子',
        effects: { mood: 5, curiosity: 4 }
      },
      {
        label: '見見老友，聽聽這些年的事',
        hint: '有些人還在，就是歸屬',
